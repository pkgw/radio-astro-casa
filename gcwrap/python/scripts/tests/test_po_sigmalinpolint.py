...
#
# <summary>
# Test suite for the CASA tool method po.sigmalinpolint
# </summary>
#
...
#
# <etymology>
# Test for the po.sigmalinpolint() tool method
# </etymology>
#
# <synopsis>
# Test the po.sigmalinpolint() tool method
# </synopsis>
#
# <example>
#
...
#
# `echo $CASAPATH/bin/casapy | sed -e 's$ $/$'` --nologger --log2term -c `echo $CASAPATH | awk '{print $1}'`/gcwrap/python/scripts/regressions/admin/runUnitTest.py test_po_sigmalinpolint[test1,test2,...]
#
# </example>
#
# <motivation>
...
class po_sigmalinpolint_test(unittest.TestCase):
