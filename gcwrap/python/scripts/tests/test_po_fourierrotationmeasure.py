...
#
# <summary>
# Test suite for the CASA tool method po.fourierrotationmeasure
# </summary>
#
...
#
# <etymology>
# Test for the po.fourierrotationmeasure() tool method
# </etymology>
#
# <synopsis>
...
# 
# `echo $CASAPATH/bin/casapy | sed -e 's$ $/$'` --nologger --log2term -c `echo $CASAPATH | awk '{print $1}'`/gcwrap/python/scripts/regressions/admin/runUnitTest.py test_po_fourierrotationmeasure[test1,test2,...]
#
# </example>
#
# <motivation>
