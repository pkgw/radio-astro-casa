...
#
# <summary>
# Test suite for the CASA tool method po.sigmadepolratio
# </summary>
#
...
#
# <etymology>
# Test for the po.sigmadepolratio() tool method
# </etymology>
#
# <synopsis>
# Test the po.sigmadepolratio() tool method
# </synopsis>
#
# <example>
#
...
#
# `echo $CASAPATH/bin/casapy | sed -e 's$ $/$'` --nologger --log2term -c `echo $CASAPATH | awk '{print $1}'`/gcwrap/python/scripts/regressions/admin/runUnitTest.py test_po_sigmadepolratio[test1,test2,...]
#
# </example>
#
# <motivation>
...
class po_sigmadepolratio_test(unittest.TestCase):
