...
#
# <summary>
# Test suite for the CASA tool method po.sigma
# </summary>
#
...
#
# <etymology>
# Test for the po.sigma() tool method
# </etymology>
#
# <synopsis>
# Test the po.sigma() tool method
# </synopsis> 
#
# <example>
#
...
# 
# `echo $CASAPATH/bin/casapy | sed -e 's$ $/$'` --nologger --log2term -c `echo $CASAPATH | awk '{print $1}'`/gcwrap/python/scripts/regressions/admin/runUnitTest.py test_po_sigma[test1,test2,...]
#
# </example>
#
# <motivation>
...
class po_sigma_test(unittest.TestCase):
