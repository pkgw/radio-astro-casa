...
#
# <summary>
# Test suite for the CASA tool method ia.fromascii()
# </summary>
#
...
#
# `echo $CASAPATH/bin/casapy | sed -e 's$ $/$'` --nologger --log2term -c `echo $CASAPATH | awk '{print $1}'`/code/xmlcasa/scripts/regressions/admin/runUnitTest.py test_ia_fromascii[test1,test2,...]
#
# </example>
#
# <motivation>
