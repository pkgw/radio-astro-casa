...
#
# <summary>
# Test suite for the CASA tool method po.totpolint
# </summary>
#
...
#
# <etymology>
# Test for the po.totpolint() tool method
# </etymology>
#
# <synopsis>
# Test the po.totpolint() tool method
# </synopsis>
#
# <example>
#
...
#
# `echo $CASAPATH/bin/casapy | sed -e 's$ $/$'` --nologger --log2term -c `echo $CASAPATH | awk '{print $1}'`/gcwrap/python/scripts/regressions/admin/runUnitTest.py test_po_totpolint[test1,test2,...]
#
# </example>
#
# <motivation>
...
class po_totpolint_test(unittest.TestCase):
