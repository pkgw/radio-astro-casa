...
#
# <summary>
# Test suite for the CASA tool method ia.set()
# </summary>
#
...
#
# `echo $CASAPATH/bin/casapy | sed -e 's$ $/$'` --nologger --log2term -c `echo $CASAPATH | awk '{print $1}'`/code/xmlcasa/scripts/regressions/admin/runUnitTest.py test_ia_set[test1,test2,...]
#
# </example>
#
# <motivation>
