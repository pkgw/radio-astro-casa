...
#
# <summary>
# Test suite for the CASA tool method po.depolratio
# </summary>
#
...
#
# <etymology>
# Test for the po.depolratio() tool method
# </etymology>
#
# <synopsis>
# Test the po.depolratio() tool method
# </synopsis> 
#
# <example>
#
...
# 
# `echo $CASAPATH/bin/casapy | sed -e 's$ $/$'` --nologger --log2term -c `echo $CASAPATH | awk '{print $1}'`/gcwrap/python/scripts/regressions/admin/runUnitTest.py test_po_depolratio[test1,test2,...]
#
# </example>
#
# <motivation>
...
class po_depolratio_test(unittest.TestCase):
