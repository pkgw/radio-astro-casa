...
#
# <summary>
# Test suite for the CASA tool method po.sigmafraclinpol
# </summary>
#
...
#
# <etymology>
# Test for the po.sigmafraclinpol() tool method
# </etymology>
#
# <synopsis>
# Test the po.sigmafraclinpol() tool method
# </synopsis>
#
# <example>
#
...
#
# `echo $CASAPATH/bin/casapy | sed -e 's$ $/$'` --nologger --log2term -c `echo $CASAPATH | awk '{print $1}'`/gcwrap/python/scripts/regressions/admin/runUnitTest.py test_po_sigmafraclinpol[test1,test2,...]
#
# </example>
#
# <motivation>
...
class po_sigmafraclinpol_test(unittest.TestCase):
