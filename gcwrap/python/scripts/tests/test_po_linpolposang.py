...
#
# <summary>
# Test suite for the CASA tool method po.linpolposang
# </summary>
#
...
#
# <etymology>
# Test for the po.linpolposang() tool method
# </etymology>
#
# <synopsis>
# Test the po.linpolposang() tool method
# </synopsis>
#
# <example>
#
...
#
# `echo $CASAPATH/bin/casapy | sed -e 's$ $/$'` --nologger --log2term -c `echo $CASAPATH | awk '{print $1}'`/gcwrap/python/scripts/regressions/admin/runUnitTest.py test_po_linpolposang[test1,test2,...]
#
# </example>
#
# <motivation>
...
class po_linpolposang_test(unittest.TestCase):
